...
struct Review: Identifiable, Hashable {
  ...
  init(id: UUID = UUID(), reviewText: String, rating: Int, userName: String) {
    self.id = id
...
struct MovieActor: Identifiable, Hashable {
  ...
  init(id: UUID = UUID(), name: String, imageUrl: String) {
    self.id = id
    self.name = name
...
struct MovieDetails: Identifiable, Hashable {
  ...
  private(set) var imageUrl: String
  private(set) var mainActors: [MovieActor]
  private(set) var supportingActors: [MovieActor]
